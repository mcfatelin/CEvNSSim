...
using BambooAnalysisFactory = SimpleFactory<BambooAnalysis, std::string, const G4String&>;

template<typename DerivedAnalysis>
using AnalysisRegister = Register<BambooAnalysis, std::string, DerivedAnalysis, const G4String&>;
