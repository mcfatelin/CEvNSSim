...
using BambooMaterialFactory = SimpleFactory<BambooMaterial, std::string, const G4String&>;

template<typename DerivedMaterial>
using MaterialRegister = Register<BambooMaterial, std::string, DerivedMaterial, const G4String&>;
