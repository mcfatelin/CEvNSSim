...
class QS1RawNest 
{
	public:
		...
		static G4ThreeVector GenAbsolutePosition(const Double_t r, const Double_t hmin, const Double_t hmax); // cylindrical region, origin at (0,0)
		static G4ThreeVector GenAbsolutePosition2(const Double_t rmin, const Double_t rmax, const Double_t hmin, const Double_t hmax); // concentric cylindrical region, origin at (0,0)
		static G4ThreeVector GenPointAbsolutePosition(const Double_t rmax, const Double_t x, const Double_t y, const Double_t z);//point region, origin at(x,y,z)
		static G4ThreeVector GenCylinderAbsolutePosition(const Double_t rmax, const Double_t x, const Double_t y, const Double_t z, const Double_t h);

		static std::vector<G4int> GenTimingPhoton(const TH1I* const h);
		static std::vector<G4ThreeVector> GenUniformDirection(Int_t np); // generate uniformly directional distribution
	...
	private:
		...
		static TRandom3 _rr, _ra, _rz, _rd,_r,_ra1,_ra2;
