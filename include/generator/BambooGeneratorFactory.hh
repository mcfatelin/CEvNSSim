...
using BambooGeneratorFactory = SimpleFactory<BambooGenerator, std::string, const G4String&>;

template<typename DerivedGenerator>
using GeneratorRegister = Register<BambooGenerator, std::string, DerivedGenerator, const G4String&>;
