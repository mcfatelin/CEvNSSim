...
using BambooPhysicsFactory = SimpleFactory<BambooPhysics, std::string, const G4String&>;

template<typename DerivedPhysics>
using PhysicsRegister = Register<BambooPhysics, std::string, DerivedPhysics, const G4String&>;
