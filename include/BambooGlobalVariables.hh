...
inline const string &DetectorParameters::getDetectorPartName() const { return name; }

inline const string &DetectorParameters::getParentName() const { return parentName; }
...
public:
    ...
    void setGLHLightSourcePos(const double xpos, const double ypos, const double zpos);

    void getGLHLightSourcePos(double &xpos, double &ypos, double &zpos);

    void setGLHSigmaR(const double sigmaR);

    void getGLHSigmaR(double& sigmaR);

    void setGLHIsUniform(const bool IsUniform);

    void getGLHIsUniform(bool& IsUniform);

    void setGLHPhotonNumber(const int np);

    void getGLHPhotonNumber(int& np);
