...
BambooGlobalVariables::BambooGlobalVariables()
    : runNumber_(0), physicsName_("SimpleUnderGroundPhysics"),
      ...
      glhx_(0),glhy_(0),glhz_(0),glhsigmaR_(0), glhIsUniform_(false), glhnp_(1000){}
...
void BambooGlobalVariables::setGLHLightSourcePos(const double xpos, const double ypos, const double zpos) {
    glhx_ = xpos;
    glhy_ = ypos;
    glhz_ = zpos;
}

void BambooGlobalVariables::getGLHLightSourcePos(double &xpos,double &ypos,double &zpos) {
    xpos = glhx_;
    ypos = glhy_;
    zpos = glhz_;
    return;
...
void BambooGlobalVariables::setGLHSigmaR(const double sigmaR) {
    glhsigmaR_ = sigmaR;
}

void BambooGlobalVariables::getGLHSigmaR(double& sigmaR) {
    sigmaR = glhsigmaR_;
    return;
}

void BambooGlobalVariables::setGLHIsUniform(const bool IsUniform) {
    glhIsUniform_ = IsUniform;
}

void BambooGlobalVariables::getGLHIsUniform(bool &IsUniform) {
    IsUniform = glhIsUniform_;
    return;
}

void BambooGlobalVariables::setGLHPhotonNumber(const int np) {
    glhnp_     = np;
}

void BambooGlobalVariables::getGLHPhotonNumber(int& np) {
    np = glhnp_;
    return;
}
